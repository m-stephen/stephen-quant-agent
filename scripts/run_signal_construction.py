...
from stephen_quant.discovery.signal_construction_launch import launch, prepare_plan, run_stage
...
def main():
    ...
    if args.command == "prepare":
        ...
        if (ROOT / "artifacts/signal-construction").resolve() not in destination.parents:
            raise ValueError(
