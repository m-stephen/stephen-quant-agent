"""Prepare and preregister a fixed construction diagnostic, then launch once."""
...
from stephen_quant.discovery.portfolio_construction_launch import launch, prepare_plan, run_stage
...
def main():
    ...
    if args.command == "prepare":
        ...
        if (ROOT / "artifacts/portfolio-construction").resolve() not in destination.parents:
            raise ValueError(
                "prepare output must stay in this worktree's ignored diagnostic artifacts"
            )
