...
Keep 2025 and 2026 sealed. The next research step is to predeclare a small candidate set,
run CPCV and falsification inside 2022-2024, and advance only candidates that pass those
tests to the untouched 2025 validation window.
